...
===============
*/
void *Mod_S_Extradata (model_t *mod)
{
	void	*r;
...
==================
*/
void Mod_S_TouchModel (char *name)
{
	model_t	*mod;
...
==================
*/
model_t *Mod_S_ForName (char *name, qboolean crash)
{
	model_t	*mod;
